...
int main(int argc, char* argv[]) {
	...
	if (SAVE_SIMULATION) {
		...
		string fileNameStr = "./results/HH_BBT_" +
				...
				to_string((int)(maxTimeSimulation/1000)) +"s_doubleBoost_IappDES.txt"; //"s_SValues72,88,86,24.txt";
		...
		fileNameStr = "./results/HH_BBT_" +
				...
				to_string(nInhNeurons) + ",vI" +
				to_string((int)vInh) + ",t=" +
				to_string((int)(maxTimeSimulation/1000)) +"s_doubleBoost_IappDES,Epis.txt";
		...
		fileNameStr = "./results/HH_BBT_" +
				...
				to_string(nInhNeurons) + ",vI" +
				to_string((int)vInh) + ",t=" +
				to_string((int)(maxTimeSimulation/1000)) +"s_doubleBoost_IappDES,Iapp.txt";
		...
		fileNameStr = "./results/HH_BBT_" +
				...
				negPosVInh +
				to_string((int)(maxTimeSimulation/1000)) + "s_doubleBoost_IappDES_Spikes.m";
